# Milestones: Pocket Monsters SoulSilver

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-SoulSilver-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters SoulSilver |
...
Coordinate reusable Nintendo DS/NARC methods with HeartGold while keeping Korean-target evidence and title-specific layouts separate.
